...
pub mod test {
    ...
    use super::*;
    use crate::modelsv2::fixtures::tests::create_test_project;
    use crate::modelsv2::prelude::*;
    ...
    async fn project_creation() {
        ...
        let created_project = create_test_project(db_pool.get_ok().deref_mut(), project_name).await;
    ...
    async fn project_retrieve() {
        let db_pool = DbConnectionPoolV2::for_tests();
        let created_project =
            create_test_project(db_pool.get_ok().deref_mut(), "test_project_name").await;
    ...
    async fn sort_project() {
        ...
        let _created_project_1 =
            create_test_project(db_pool.get_ok().deref_mut(), "test_project_name_1").await;
        let _created_project_2 =
            create_test_project(db_pool.get_ok().deref_mut(), "test_project_name_2").await;
