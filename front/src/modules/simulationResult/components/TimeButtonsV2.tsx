...
type TimeButtonsV2Props = {
  departureTime: string;
};

const TimeButtonsV2 = ({ departureTime }: TimeButtonsV2Props) => {
  ...
  const stop = () => {
    ...
    updateTimePosition(dayjs(departureTime, 'D/MM/YYYY HH:mm:ss').toDate());
