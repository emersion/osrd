...
import type { GevPreparedDataV2 } from 'modules/simulationResult/components/SpeedSpaceChart/types';
...
export const enableInteractivityV2 = <
  T extends Chart | SpeedSpaceChart,
  Data extends SimulationTrain<Date> | GevPreparedDataV2 | SpaceCurvesSlopesData,
>(
  chart: T | undefined,
  selectedTrainData: Data,
  keyValues: ChartAxes,
