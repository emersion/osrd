...
import type { GevPreparedDataV2 } from '../SpeedSpaceChart/types';
...
export const drawCurveV2 = <
  T extends
    | ArrayElement<
        GevPreparedDataV2[keyof Omit<GevPreparedDataV2, 'electrifications' | 'pathLength'>]
      >
